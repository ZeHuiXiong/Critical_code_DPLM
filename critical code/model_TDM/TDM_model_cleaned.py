...
excel_file_path = 'TDMs_cleaned.xlsx'
...
model.save_model('model_TDM_cleaned.json')
...
plt.title("Confusion matrix of the TDM model after feature engineering", fontname='Arial')
