...
excel_file_path = 'Semi_cleaned.xlsx'
...
model.save_model('model_SEMI_cleaned.json')
...
plt.title("Confusion matrix of the Semi model after feature engineering", fontname='Arial')
